...
public:
	...
	CVect3 wib, fb, fn, an, web, wnb, att, vn, vb, pos, eb, db, ebMax, dbMax, _tauGyro, _tauAcc;
	...
	void SetedMax(CVect3 &e, CVect3 &d);
...
public:
	...
	int nq, nr, measflag;
	CMat Ft, Pk, Hk;
	CVect Xk, Zk, Qt, Rt, rts, Pmax, Pmin, FBTau;
	...
	void TimeUpdate(double kfts);			// time update
...
public:
	...
	CFileRdWt(char *dir);
	CFileRdWt(char *fname0, int columns);
